...
| OBS-05 | app/observability/metrics.py + otel.py + protocol/routes/metrics.py; tests/test_protocol/test_metrics.py |
...
| SES-06 | app/storage/* (sweep/ttl); app/protocol/app.py (lifespan sweep task); tests/test_storage/test_contract.py::TestSweep |
