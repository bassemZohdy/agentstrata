...
# whose hash is present in the lock. Does not install anything.
#
...
"$UV" pip install --dry-run --require-hashes -r requirements.lock
"$UV" pip install --dry-run --require-hashes -r requirements-dev.lock
